...
export default async function HomePage({
  ...
  return (
    <main className="flex flex-col">
      ...
      */}
      <section className="flex min-h-[max(20rem,calc(100svh-env(safe-area-inset-top,0px)-3.5rem-18rem))] flex-col items-center justify-center px-6 py-14 sm:py-16 md:py-20">
